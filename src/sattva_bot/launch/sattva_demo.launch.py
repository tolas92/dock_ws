...
def generate_launch_description():
    ...
    """
    sattva_dock_config_dir = os.path.join(
        get_package_share_directory('sattva_bot'), 'config')

    config_file =os.path.join(sattva_dock_config_dir, 'sattva_params.yaml')
    ...
    warehouse_node=Node(
        package='sattva_bot',
        executable='sattva_warehouse_demo.py',
        parameters=[config_file]
    )
